 ...
 * Time: 10:22 PM
 */
//Class for working with images. At the moment it nas only one static function... maybe it will be more usable later...

Class Image {
    public static function generateThumbnail($srcFilePath, $destFoldPath, $thmbHW)
    {
